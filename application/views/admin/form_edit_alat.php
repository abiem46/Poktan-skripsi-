      ...
      <div class="section">
        <div class="row">
          <div class="col ml-auto mr-auto">
            <h1 class="text-center">Form Edit Alat</h1>
            <form method="post" action="<?=base_url('admin/edit_alat/' . $stok_alat['id']);?>" >
                <div class="form-row">
                    <div class="form-group col-md-4">
                        <label for="nama">Nama Alat</label>
                        <input type="text" id="nama" name="nama" class="form-control" value="<?=$stokalat['nama'];?>">
                    </div>
                </div>
                <div class="form-row">
                    <div class="form-group col-md-4">
