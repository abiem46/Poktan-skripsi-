      ...
      <div class="section">
        <div class="row">
          <div class="col ml-auto mr-auto">
            ...
            <form method="post" action="<?=base_url('admin/edit_surat/' . $surat_pengantar['id_anggota']);?>" >
                <div class="form-row">
                    <div class="form-group col-md-4">
                        <label for="id_anggota">Id Anggota</label>
                        <input type="text"  id="id_anggota" name="id_anggota" class="form-control" value="<?=$surat_pengantar['id_anggota'];?>" readonly> 
                    </div>
                </div>
                <div class="form-row">
                    <div class="form-group col-md-4">
